...
function TodoItem({ todo }) {
    ...
    return (
        <div
            className={`flex border border-black rounded-lg px-3 py-1.5 gap-x-2 shadow-sm shadow-white/50 duration-300  text-black ${
                todo.completed ? "bg-[#bbebbcb3]" : "bg-[#fcfcfc95]"
            }`}
        >
            <input
                type="checkbox"
