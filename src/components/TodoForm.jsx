    ...
    return (
        <form onSubmit={add} className="flex">  {/* giving event */}
            <input   
                ...
                className="w-full px-4 py-1.5 duration-150 rounded-l-lg outline-none border-gray-800 bg-black/30 border-5 border backdrop-filter backdrop-brightness-40 text-sm sm:text-base sm:px-7 sm:py-2 text-[#eceff1]"
            ...
            />
            <button type="submit" className=" px-3 py-2 bg-green-500 border rounded-r-lg shrink-0 border-slate-800 sm:text-sm sm:px-4 sm:py-2 text-[#212121] text-xl">
                Add
            </button>
        </form>
    );
